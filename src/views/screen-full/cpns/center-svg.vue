...
<template>
  <div class="center-svg">
    ...
    >
      ...
      <defs>
        ...
        <image
          ...
          width="23"
          height="23"
          xlink:href="@/assets/img/screenfull/center/image-1.png"
        />
        <image
          id="image-2"
          width="15"
          height="15"
          xlink:href="@/assets/img/screenfull/center/image-2.png"
        />
      </defs>
      <!-- 复用的defs -->
      <g id="dongxiao1">
        <g id="icon">
          ...
          <image
            ...
            width="112"
            height="112"
            xlink:href="@/assets/img/screenfull/center/star.png"
          />
          <path
            id="base_o-2"
            data-name="base_o"
          ...
          <image
            ...
            width="106"
            height="107"
            xlink:href="@/assets/img/screenfull/center/location.png"
          />
          <path
            id="base_o-3"
            data-name="base_o"
          ...
          <image
            ...
            width="107"
            height="108"
            xlink:href="@/assets/img/screenfull/center/pie.png"
          />
          <path
            id="base_o-4"
            data-name="base_o"
          ...
          <image
            ...
            width="111"
            height="112"
            xlink:href="@/assets/img/screenfull/center/earth.png"
          />
          <path
            id="base_o-5"
            data-name="base_o"
          ...
          <image
            ...
            width="105"
            height="105"
            xlink:href="@/assets/img/screenfull/center/hot.png"
          />
          <path
            id="base_o-6"
            data-name="base_o"
          ...
          <image
            ...
            width="103"
            height="103"
            xlink:href="@/assets/img/screenfull/center/home.png"
          />
        </g>
        <g id="circle">
          <path
          ...
          <image
            ...
            width="72"
            height="92"
            xlink:href="@/assets/img/screenfull/center/light_0_3.png"
          />
          <image
            id="light_o_2"
            x="141"
            ...
            width="99"
            height="137"
            xlink:href="@/assets/img/screenfull/center/light_0_2.png"
          />
          <image
            id="light_o_1"
            x="436"
            ...
            width="99"
            height="66"
            xlink:href="@/assets/img/screenfull/center/light_0_1.png"
          />
        </g>
        <image
          id="center-houes"
          ...
          width="539"
          height="419"
          xlink:href="@/assets/img/screenfull/center/house.png"
        />
        <g id="right">
          <g id="组_380" data-name="组 380">
            ...
            <g id="dots_b">
              ...
              <image
                ...
                width="22"
                height="23"
                xlink:href="@/assets/img/screenfull/center/dots28.png"
              />
              <circle
                id="dots27"
                class="cls-40"
    ...
    <!-- 防烟花特效 -->
    <img class="lingxA" src="@/assets/img/screenfull/ling/lingxA.png" />
    <img class="lingxB" src="@/assets/img/screenfull/ling/lingxB.png" />
    <img class="lingxC" src="@/assets/img/screenfull/ling/lingxC.png" />
    <img class="lingxD" src="@/assets/img/screenfull/ling/lingxD.png" />
    <img class="lingxE" src="@/assets/img/screenfull/ling/lingxE.png" />
    <img class="lingxF" src="@/assets/img/screenfull/ling/lingxF.png" />
  </div>
</template>
